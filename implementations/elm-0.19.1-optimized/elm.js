...
var $author$project$Todo$init = function (_v0) {
	return _Utils_Tuple2($author$project$Todo$emptyModel, $elm$core$Platform$Cmd$none);
};
...
var $author$project$Todo$viewKeyedEntry = function (todo) {
	return _Utils_Tuple2(
		$elm$core$String$fromInt(todo.g),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Lazy$lazy, $author$project$Todo$viewInput, model.u),
						A3($elm$html$Html$Lazy$lazy2, $author$project$Todo$viewEntries, model.K, model.a),
						A3($elm$html$Html$Lazy$lazy2, $author$project$Todo$viewControls, model.K, model.a)
					])),
